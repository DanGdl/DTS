...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SPI0_REF_CTRL_DIVISOR1                          0x5
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E007C, 0x013F3F07U ,0x01053C00U)
    */
	PSU_Mask_Write(CRL_APB_SPI0_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01053C00U);
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SPI1_REF_CTRL_DIVISOR0                          0x13
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0080, 0x013F3F07U ,0x01011300U)
    */
	PSU_Mask_Write(CRL_APB_SPI1_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01011300U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL0_REF_CTRL_DIVISOR1                           0x28
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C0, 0x013F3F07U ,0x01283202U)
    */
	PSU_Mask_Write(CRL_APB_PL0_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01283202U);
/*##################################################################### */
